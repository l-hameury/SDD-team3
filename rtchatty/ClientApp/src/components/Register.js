...
const Register = () => {
    ...
    return (
        <div>
            ...
            <div className="alert alert-success" hidden={!showSuccess} name="successAlert">Success! An account has been created. Return to <a href="/" className="alert-link">login</a> to sign-in.</div>
